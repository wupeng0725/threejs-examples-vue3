const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["static/js/Texture-Dwk1Le4c.js","static/js/three-DQzz9mVt.js","static/js/OrbitControls-gXHa7bTO.js","static/js/highlight-CPa5cjrO.js","static/js/PrimitivesGeometry-BOUKj1Lx.js"])))=>i.map(i=>d[i]);
import{r as j,c as G,d as K,b as T,e as x,F as oe,f as le,u as ce,n as de,t as $,g as ue,h as me,i as pe,j as he,k as ge,l as fe,m as ve,p as Ee,q as _e,s as we,v as Re,w as ye,x as Le,y as xe,z as Te,A as be,B as Me,C as He,D as Se,E as Pe,G as Ce,H as Ie,I as Ge,J as ke,K as Be,L as je,M as Ae,N as Oe,O as De,P as qe,Q as ze,R as Ue,S as Fe,T as Ve,U as We,V as $e,W as Ne,X as Ye,Y as z,Z as se,_ as Je,$ as Xe,a0 as re,a1 as Ke,a2 as B,a3 as Qe,a4 as Ze,a5 as er,a6 as rr,o as nr,a as tr}from"./highlight-CPa5cjrO.js";import{aa as ar,ab as V,ac as Y,ad as W,a7 as or,ae as ne,af as sr,W as ir,P as lr,b as cr,c as dr,D as ur,z as mr,M as pr}from"./three-DQzz9mVt.js";(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))l(r);new MutationObserver(r=>{for(const c of r)if(c.type==="childList")for(const n of c.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&l(n)}).observe(document,{childList:!0,subtree:!0});function a(r){const c={};return r.integrity&&(c.integrity=r.integrity),r.referrerPolicy&&(c.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?c.credentials="include":r.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function l(r){if(r.ep)return;r.ep=!0;const c=a(r);fetch(r.href,c)}})();const hr="modulepreload",gr=function(e){return"/threejs-examples-vue3/"+e},te={},y=function(i,a,l){let r=Promise.resolve();if(a&&a.length>0){document.getElementsByTagName("link");const n=document.querySelector("meta[property=csp-nonce]"),s=(n==null?void 0:n.nonce)||(n==null?void 0:n.getAttribute("nonce"));r=Promise.allSettled(a.map(f=>{if(f=gr(f),f in te)return;te[f]=!0;const R=f.endsWith(".css"),b=R?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${f}"]${b}`))return;const d=document.createElement("link");if(d.rel=R?"stylesheet":hr,R||(d.as="script"),d.crossOrigin="",d.href=f,s&&d.setAttribute("nonce",s),document.head.appendChild(d),R)return new Promise((E,p)=>{d.addEventListener("load",E),d.addEventListener("error",()=>p(new Error(`Unable to preload CSS for ${f}`)))})}))}function c(n){const s=new Event("vite:preloadError",{cancelable:!0});if(s.payload=n,window.dispatchEvent(s),!s.defaultPrevented)throw n}return r.then(n=>{for(const s of n||[])s.status==="rejected"&&c(s.reason);return i().catch(c)})},fr="/threejs-examples-vue3/github.svg",vr=[{title:"三个基础盒子",value:"ThreeBox",type:"demo"},{title:"几何体汇总",value:"PrimitivesGeometry",type:"demo"},{title:"轨道控制器",value:"OrbitControls",type:"demo"},{title:"lil-gui调试器",value:"GUI",type:"demo"},{title:"纹理贴图",value:"Texture",type:"demo"},{title:"点光源",value:"PointLight",type:"demo"},{title:"聚光灯",value:"SpotLight",type:"demo"},{title:"3D圣诞贺卡",value:"christmas-card",type:"link"}],Q=(e,i)=>{const a=e.__vccOpts||e;for(const[l,r]of i)a[l]=r;return a},Er={key:0,id:"panel"},_r=["onClick"],wr={__name:"Panel",emits:["componentChange"],setup(e,{emit:i}){const a=i,l=j(""),r=s=>{s.type==="demo"?(l.value=s.value,a("componentChange",s)):c(s.value)},c=s=>{window.open(`https://wupeng0725.github.io/${s}/`,"_blank")},n=j(!0);return(s,f)=>n.value?(T(),G("div",Er,[f[0]||(f[0]=x("div",{class:"panel-header"},[x("span",{class:"title"},"Threejs 样例"),x("a",{href:"https://github.com/wupeng0725/threejs-examples-vue3",target:"_blank",title:"Github源码"},[x("img",{src:fr,alt:"Github源码"})])],-1)),(T(!0),G(oe,null,le(ce(vr),(R,b)=>(T(),G("div",{class:de(["panel-item",R.value===l.value&&"selected"]),key:R.value,onClick:d=>r(R)},$(b+1)+" - "+$(R.title),11,_r))),128))])):K("",!0)}},Rr=Q(wr,[["__scopeId","data-v-89821aa2"]]),yr={},Lr={class:"empty"};function xr(e,i){return T(),G("div",Lr," Select an example from the sidebar ")}const Tr=Q(yr,[["render",xr],["__scopeId","data-v-0f616578"]]);var J,ae;function br(){if(ae)return J;ae=1;var e=ue();return e.registerLanguage("xml",me()),e.registerLanguage("bash",pe()),e.registerLanguage("c",he()),e.registerLanguage("cpp",ge()),e.registerLanguage("csharp",fe()),e.registerLanguage("css",ve()),e.registerLanguage("markdown",Ee()),e.registerLanguage("diff",_e()),e.registerLanguage("ruby",we()),e.registerLanguage("go",Re()),e.registerLanguage("graphql",ye()),e.registerLanguage("ini",Le()),e.registerLanguage("java",xe()),e.registerLanguage("javascript",Te()),e.registerLanguage("json",be()),e.registerLanguage("kotlin",Me()),e.registerLanguage("less",He()),e.registerLanguage("lua",Se()),e.registerLanguage("makefile",Pe()),e.registerLanguage("perl",Ce()),e.registerLanguage("objectivec",Ie()),e.registerLanguage("php",Ge()),e.registerLanguage("php-template",ke()),e.registerLanguage("plaintext",Be()),e.registerLanguage("python",je()),e.registerLanguage("python-repl",Ae()),e.registerLanguage("r",Oe()),e.registerLanguage("rust",De()),e.registerLanguage("scss",qe()),e.registerLanguage("shell",ze()),e.registerLanguage("sql",Ue()),e.registerLanguage("swift",Fe()),e.registerLanguage("yaml",Ve()),e.registerLanguage("typescript",We()),e.registerLanguage("vbnet",$e()),e.registerLanguage("wasm",Ne()),e.HighlightJS=e,e.default=e,J=e,J}br();const Mr={class:"model-header"},Hr={class:"model-title"},Sr={class:"model-tag-box"},Pr={class:"model-content"},Cr={__name:"CodeModel",props:{modelData:Object},setup(e){const i=e,a=j(!1),l=j("复制原文"),r=async()=>{try{await navigator.clipboard.writeText(i.modelData.code),l.value="复制成功"}catch{l.value="复制失败"}setTimeout(()=>{l.value="复制原文"},1500)},c=j(null),n=()=>{var s;(s=c.value)==null||s.requestFullscreen()};return(s,f)=>{const R=Ye("highlightjs");return T(),G(oe,null,[(T(),z(Je,{to:"body"},[a.value?(T(),G("div",{key:0,class:"modal",ref_key:"modelRef",ref:c},[x("div",Mr,[x("div",Hr,"源码："+$(e.modelData.title),1),x("div",Sr,[x("span",{class:"model-tag-copy",onClick:r},$(l.value),1),x("span",{class:"model-tag-fullscreen",onClick:n},"全屏"),x("span",{class:"model-tag-close",onClick:f[0]||(f[0]=b=>a.value=!1)},"×")])]),x("div",Pr,[se(R,{language:"XML",autodetect:!1,code:e.modelData.code},null,8,["code"])])],512)):K("",!0)])),x("span",{onClick:f[1]||(f[1]=b=>a.value=!0),class:"checkcode"},"查看源码")],64)}}},Ir=Q(Cr,[["__scopeId","data-v-103f8c73"]]),Gr=async e=>{try{const i=Object.assign({"/src/views/GUI.vue":()=>y(()=>import("./ThreeBox-Dg2u5zpM.js").then(r=>r.G),[]),"/src/views/OrbitControls.vue":()=>y(()=>Promise.resolve().then(()=>zr),void 0),"/src/views/PointLight.vue":()=>y(()=>Promise.resolve().then(()=>Fr),void 0),"/src/views/PrimitivesGeometry.vue":()=>y(()=>import("./ThreeBox-Dg2u5zpM.js").then(r=>r.P),[]),"/src/views/SpotLight.vue":()=>y(()=>Promise.resolve().then(()=>Wr),void 0),"/src/views/Texture.vue":()=>y(()=>Promise.resolve().then(()=>Nr),void 0),"/src/views/ThreeBox.vue":()=>y(()=>import("./ThreeBox-Dg2u5zpM.js").then(r=>r.T),[])}),a=`/src/views/${e}.vue`;if(!i[a])throw new Error(`路径不存在: ${a}`);return(await i[a]()).default}catch{return""}};function kr(e){return"/threejs-examples-vue3/"+e.replace(/^\//,"")}class Br extends ar{constructor(i){super(i),this.type=V}parse(i){const n=function(t,u){switch(t){case 1:throw new Error("THREE.RGBELoader: Read Error: "+(u||""));case 2:throw new Error("THREE.RGBELoader: Write Error: "+(u||""));case 3:throw new Error("THREE.RGBELoader: Bad File Format: "+(u||""));default:case 4:throw new Error("THREE.RGBELoader: Memory Error: "+(u||""))}},b=`
...
`;continue}if((m=w.match(h))&&(o.gamma=parseFloat(m[1])),(m=w.match(g))&&(o.exposure=parseFloat(m[1])),(m=w.match(_))&&(o.valid|=2,o.format=m[1]),(m=w.match(v))&&(o.valid|=4,o.height=parseInt(m[1],10),o.width=parseInt(m[2],10)),o.valid&2&&o.valid&4)break}return o.valid&2||n(3,"missing format specifier"),o.valid&4||n(3,"missing image size specifier"),o},p=function(t,u,h){const g=u;if(g<8||g>32767||t[0]!==2||t[1]!==2||t[2]&128)return new Uint8Array(t);g!==(t[2]<<8|t[3])&&n(3,"wrong scanline width");const _=new Uint8Array(4*u*h);_.length||n(4,"unable to allocate buffer space");let v=0,o=0;const w=4*g,m=new Uint8Array(4),D=new Uint8Array(w);let Z=h;for(;Z>0&&o<t.byteLength;){o+4>t.byteLength&&n(1),m[0]=t[o++],m[1]=t[o++],m[2]=t[o++],m[3]=t[o++],(m[0]!=2||m[1]!=2||(m[2]<<8|m[3])!=g)&&n(3,"bad rgbe scanline format");let q=0,P;for(;q<w&&o<t.byteLength;){P=t[o++];const C=P>128;if(C&&(P-=128),(P===0||q+P>w)&&n(3,"bad scanline data"),C){const I=t[o++];for(let ee=0;ee<P;ee++)D[q++]=I}else D.set(t.subarray(o,o+P),q),q+=P,o+=P}const ie=g;for(let C=0;C<ie;C++){let I=0;_[v]=D[C+I],I+=g,_[v+1]=D[C+I],I+=g,_[v+2]=D[C+I],I+=g,_[v+3]=D[C+I],v+=4}Z--}return _},L=function(t,u,h,g){const _=t[u+3],v=Math.pow(2,_-128)/255;h[g+0]=t[u+0]*v,h[g+1]=t[u+1]*v,h[g+2]=t[u+2]*v,h[g+3]=1},M=function(t,u,h,g){const _=t[u+3],v=Math.pow(2,_-128)/255;h[g+0]=W.toHalfFloat(Math.min(t[u+0]*v,65504)),h[g+1]=W.toHalfFloat(Math.min(t[u+1]*v,65504)),h[g+2]=W.toHalfFloat(Math.min(t[u+2]*v,65504)),h[g+3]=W.toHalfFloat(1)},H=new Uint8Array(i);H.pos=0;const S=E(H),U=S.width,F=S.height,A=p(H.subarray(H.pos),U,F);let k,N,O;switch(this.type){case Y:O=A.length/4;const t=new Float32Array(O*4);for(let h=0;h<O;h++)L(A,h*4,t,h*4);k=t,N=Y;break;case V:O=A.length/4;const u=new Uint16Array(O*4);for(let h=0;h<O;h++)M(A,h*4,u,h*4);k=u,N=V;break;default:throw new Error("THREE.RGBELoader: Unsupported type: "+this.type)}return{width:U,height:F,data:k,header:S.string,gamma:S.gamma,exposure:S.exposure,type:N}}setDataType(i){return this.type=i,this}load(i,a,l,r){function c(n,s){switch(n.type){case Y:case V:n.colorSpace=or,n.minFilter=ne,n.magFilter=ne,n.generateMipmaps=!1,n.flipY=!0;break}a&&a(n,s)}return super.load(i,c,l,r)}}const X={},jr=e=>{const i=new sr,a=new Br;return Promise.all(e.map(l=>X[l]?Promise.resolve():new Promise((r,c)=>{(l.includes("hdr")?a:i).load(kr(l),s=>{X[l]=s,r()},void 0,s=>c(s))})))},Qr=e=>X[e],Ar={id:"wrapper"},Or={id:"viewer"},Dr={__name:"App",setup(e){const i=B(()=>y(()=>import("./Texture-Dwk1Le4c.js").then(p=>p.P),__vite__mapDeps([0,1,2,3]))),a=B(()=>y(()=>import("./Texture-Dwk1Le4c.js").then(p=>p.S),__vite__mapDeps([0,1,2,3]))),l=B(()=>y(()=>Promise.resolve().then(()=>Jr),void 0)),r=B(()=>y(()=>import("./OrbitControls-gXHa7bTO.js").then(p=>p.a),__vite__mapDeps([2,1,3]))),c=B(()=>y(()=>import("./PrimitivesGeometry-BOUKj1Lx.js"),__vite__mapDeps([4,1,3]))),n=B(()=>y(()=>import("./Texture-Dwk1Le4c.js").then(p=>p.G),__vite__mapDeps([0,1,2,3]))),s=B(()=>y(()=>import("./Texture-Dwk1Le4c.js").then(p=>p.T),__vite__mapDeps([0,1,2,3])));jr(["/texture/door/color.jpg","/texture/door/ambientOcclusion.jpg","/texture/door/alpha.jpg","/texture/door/specular.jpg"]).catch(p=>{});const R=Xe({code:"",title:""}),b={PointLight:i,SpotLight:a,ThreeBox:l,PrimitivesGeometry:c,OrbitControls:r,GUI:n,Texture:s},d=j(""),E=async({value:p,title:L})=>{d.value=p,R.code=await Gr(p),R.title=L};return(p,L)=>(T(),G("div",Ar,[se(Rr,{onComponentChange:E}),x("div",Or,[d.value?(T(),z(Ze,{key:0},{fallback:re(()=>L[0]||(L[0]=[Qe(" Loading... ")])),default:re(()=>[(T(),z(Ke(b[d.value])))]),_:1})):(T(),z(Tr,{key:1})),d.value?(T(),z(Ir,{key:2,modelData:R},null,8,["modelData"])):K("",!0)])]))}};er(Dr).use(rr).mount("#app");const qr=`<template>\r
...
<\/script>\r
\r
<style lang="scss" scoped></style>`,Nr=Object.freeze(Object.defineProperty({__proto__:null,default:$r},Symbol.toStringTag,{value:"Module"})),Yr={__name:"ThreeBox",setup(e){const i=j(null);let a=null,l=null,r=null,c=null,n=[];function s(){a=new ir({canvas:i.value,antialias:!0});const d=75,E=window.innerWidth/window.innerHeight,p=.1,L=1e3;l=new lr(d,E,p,L),l.position.z=3,r=new cr;const M=new dr(1,1,1);function H(S,U,F){const A=new mr({color:U}),k=new pr(S,A);return r.add(k),k.position.x=F,k}n=[H(M,4500104,0),H(M,8930474,-2),H(M,11176004,2)];{const S=new ur(16777215,3);S.position.set(-1,2,4),r.add(S)}}function f(d){const E=d.domElement,p=window.devicePixelRatio,L=Math.floor(E.clientWidth*p),M=Math.floor(E.clientHeight*p),H=E.width!==L||E.height!==M;return H&&d.setSize(L,M,!1),H}const R=()=>{c&&cancelAnimationFrame(c),r.traverse(d=>{d.isMesh&&(d.geometry.dispose(),d.material.dispose())}),a.dispose(),a.forceContextLoss(),a.domElement=null,a=null,r=null,l=null,n=[],i.value=null};function b(d){if(d*=.001,n.forEach((E,p)=>{const L=1+p*.1,M=d*L;E.rotation.x=M,E.rotation.y=M}),f(a)){const E=a.domElement;l.aspect=E.clientWidth/E.clientHeight,l.updateProjectionMatrix()}a.render(r,l),c=requestAnimationFrame(b)}return nr(()=>{s(),requestAnimationFrame(b)}),tr(()=>{R()}),(d,E)=>(T(),G("canvas",{ref_key:"canvasRef",ref:i},null,512))}},Jr=Object.freeze(Object.defineProperty({__proto__:null,default:Yr},Symbol.toStringTag,{value:"Module"}));export{Br as R,Qr as g,kr as w};
